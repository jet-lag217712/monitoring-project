...
Local Docker Compose with **every** service in one project. Use this for quick validation on a client site (or any single host with Docker and reachable SNMP devices).
